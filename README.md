...
Para além disto, existe uma barra de pesquisa através da qual é possível procurar por nome(s), ou até mesmo filtrar por intervalo de datas ou local.
...
<h1></h1>
<h3>8.Registo</h3>
    Para registar um utilizador na base de dados é necessário inserir Nome, E-mail, Password . Apenas é possível registar utilizadores, para registr administradores, os dados terão de ser inseridos manualmente na Base de Dados
